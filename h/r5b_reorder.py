...
t0=time.time(); multi=g["fetch_dart_multi_accounts"](corps,years); show("1 multi",t0)
t0=time.time(); dis=g["fetch_dart_disclosures"]("2016-08-01","2026-07-31"); show("2 disclosures",t0); print("   dis rows:",len(dis))
t0=time.time(); emp=g["fetch_dart_employees"](corps,years); show("3 employees",t0); print("   emp rows:",len(emp))
t0=time.time(); fs=g["fetch_dart_financials"](corps,years,priority=[]); show("4 financials",t0); print("   fs rows:",len(fs))
